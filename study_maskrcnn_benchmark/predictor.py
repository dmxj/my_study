...
class Predictor(object):
    ...
    def run_on_batch_image(self,original_image_list):
        """
        batch inference
        ...
        def post_process(original_image,prediction):
            ...
            self.top_predictions.append(top_predictions)
        ...
        result = [post_process(original_image,pred) for original_image,pred in list(zip(original_image_list,predictions))]
        return result
